<div id="page-wrapper" style="overflow: scroll;max-height:500px;">
    <div class="panel panel-default">
      <div class="panel-body"><center> <b>Add  Flavours </b> </center> </div>
    </div>
    <hr>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="col-lg-12" style="padding-top: 50px;">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="flavour_name" value="" class="form-control" id="flavour_name">
                     ...
                     <div class="col-lg-12" style="padding-top: 50px;">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="large_price" value="" class="form-control" id="large_price">
                    ...
                    <div class="col-lg-12" style="padding-top: 50px;">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="flavour_price" value="" class="form-control" id="flavour_price">
