<div id="page-wrapper" >
    <div class="panel panel-default">
      <div class="panel-body"><center> <b> Edit Category </b> </center> </div>
    </div>
    <hr>

    <div class="col-md-12" style="margin-top: 20px;overflow-y: scroll;min-height: 20px;">  
        <?php echo form_open('','id="frmcategory"'); ?>
            <input type="hidden" name="id" value="<?php echo $cat_details[0]['cat_id']?>">
            <div class="panel">
                <div class="panel-body">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="cat_name" class="form-control" value="<?php echo $cat_details[0]['cat_name']?>">
                        </div>
