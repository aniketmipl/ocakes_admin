<div id="page-wrapper" >
    ...
    <div class="col-md-12" style="margin-top: 20px;overflow-y: scroll;min-height: 20px;">  
        ...
        <input type="hidden" name="sub_cat_id" value="<?php echo $subcat_details[0]['sub_cat_id']?>">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="col-lg-12" style="padding-top: 50px;">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="sub_cat_name" id="sub_cat_name" class="form-control" value="<?php echo $subcat_details[0]['sub_cat_name']?>">
                        </div>
